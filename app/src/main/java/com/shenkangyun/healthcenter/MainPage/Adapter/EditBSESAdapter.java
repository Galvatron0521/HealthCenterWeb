...
public class EditBSESAdapter extends BaseQuickAdapter<EditBSDSBean.DataBean.FieldListBean.ChildListBeanX, BaseViewHolder> {


    public EditBSESAdapter() {
        super(R.layout.item_bses, null);
    }

    @Override
    protected void convert(BaseViewHolder helper, EditBSDSBean.DataBean.FieldListBean.ChildListBeanX item) {
