...
public class PersonalActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        for (int i = 0; i < all.size(); i++) {
            ...
            brithday = all.get(i).getBrithday();
    ...
    private void initData() {
        if (!TextUtils.isEmpty(String.valueOf(age))) {
            docAge.setText(String.valueOf(age) + "岁");
        }
        ...
        if (!TextUtils.isEmpty(String.valueOf(husbandAge))) {
            tvHusbandAge.setText(String.valueOf(husbandAge) + "岁");
        }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_info:
                ...
                intentConsummate.putExtra("idCard", idCard);
                intentConsummate.putExtra("mobile", mobile);
                intentConsummate.putExtra("loginName", loginName);
