...
public class MyExpandableListViewAdapter extends BaseExpandableListAdapter {
    ...
    public MyExpandableListViewAdapter(Context context, List<String> Month, List<List<EPDSEntity>> epdsEntities) {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        childViewHolder.tvTitle.setText(entities.get(groupPosition).get(childPosition).getResults());
        return convertView;
    }
