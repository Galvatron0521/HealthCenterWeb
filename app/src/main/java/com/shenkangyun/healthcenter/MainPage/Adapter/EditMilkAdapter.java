...
public class EditMilkAdapter extends BaseMultiItemQuickAdapter<EditMilkBean.DataBean.FieldListBean.ChildListBeanX, BaseViewHolder> {


    public EditMilkAdapter() {
        super(null);
    ...
    @Override
    protected void convert(BaseViewHolder helper, EditMilkBean.DataBean.FieldListBean.ChildListBeanX item) {
